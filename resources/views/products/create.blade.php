...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h2 text-primary-emphasis">Créer un nouveau produit</h1>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('family') is-invalid @enderror" id="family" name="family" required>
                            ...
                            <option value="GM" {{ old('family') == 'GM' ? 'selected' : '' }}>GM</option>
                            <option value="PM" {{ old('family') == 'PM' ? 'selected' : '' }}>PM</option>
                        </select>
                        @error('family')
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                            ...
                            <option value="Épicée" {{ old('type') == 'Épicée' ? 'selected' : '' }}>Épicée</option>
                            <option value="Pimentée" {{ old('type') == 'Pimentée' ? 'selected' : '' }}>Pimentée</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                            ...
                            <option value="Payer" {{ old('status') == 'Payer' ? 'selected' : '' }}>Payé</option>
                            <option value="Non Payer" {{ old('status') == 'Non Payer' ? 'selected' : '' }}>Non Payé</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
